...
from test_framework.test_framework import OsinTestFramework
...
class LLMQChainLocksTest(OsinTestFramework):
    def set_test_params(self):
        self.set_osin_test_params(6, 5, fast_dip3_enforcement=True)
