...
"""Verify that starting osind with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start osind with -h for help text")
        ...
        self.log.info("Start osind with -version for version information")
