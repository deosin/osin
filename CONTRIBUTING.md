Contributing to Osin Core
============================

The Osin Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/deosin/osin/blob/master/doc/translation_process.md) 
...
The following applies to code changes to the Osin Core project (and related
projects such as libsecp256k1), and is not to be confused with overall Osin
Network Protocol consensus changes.

Whether a pull request is merged into Osin Core rests with the project merge
...
Patches that change Osin consensus rules are considerably more involved than
...
Where a patch set proposes to change the Osin consensus, it must have been
...
The review process is normally fairly responsive on the Osin Core repository, however
...
The project leader is the release manager for each Osin Core release.
