...
* osin.conf: contains configuration settings for osind or osin-qt
* osind.pid: stores the process id of osind while running
* database/*: BDB database environment; only used for wallet
* db.log: wallet database log file
* debug.log: contains debug information and general logging generated by osind or osin-qt
