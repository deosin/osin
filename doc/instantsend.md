...
This mechanism has been integrated into Bitcore-Node-Osin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/deosin/insight-api-osin#web-socket-api](https://github.com/deosin/insight-api-osin#web-socket-api)
* API: [https://github.com/deosin/insight-api-osin#instantsend-transactions](https://github.com/deosin/insight-api-osin#instantsend-transactions)
