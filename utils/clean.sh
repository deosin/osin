...
rm -rf test_bitcoin.coverage/ osin-gtest.coverage/ total.coverage/
...
clean_exe src/osin-cli
clean_exe src/osind
clean_exe src/osin-gtest
clean_exe src/osin-tx
clean_exe src/test/test_osin
clean_exe src/test/test_osin_fuzzy
...
clean_dep . src/config/osin-config.h.in
