...
official/supported Docker Images found at https://hub.docker.com/r/osin/osind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/osin/osind-develop/ when changing the above text**