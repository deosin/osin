...
//! Interface for the src/evo part of a osin node (osind process).
class EVO
{
public:
    virtual ~EVO() {}
...
//! Interface for the src/llmq part of a osin node (osind process).
class LLMQ
{
public:
    virtual ~LLMQ() {}
...
//! Interface for the src/masternode part of a osin node (osind process).
namespace Smartnode
{
class Sync
{
...
//! Top-level interface for a osin node (osind process).
class Node
{
public:
    virtual ~Node() {}
