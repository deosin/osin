...
/** Utility functions used by the Osin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "osin:" URI into recipient object, return true on successful parsing
    ...
    */
    ...
    /** Load osin specific appliciation fonts */
    bool loadFonts();
    ...
    /** Check if a osin specific theme is activated (light/dark).*/
