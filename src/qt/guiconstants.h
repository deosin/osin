...
/* OsinGUI -- Size of icons in status bar */
static const int STATUSBAR_ICONSIZE = 18;

/* OsinGUI -- Size of button icons e.g. in SendCoinEntry or SignVerifyMessageDialog */
...
#define QAPP_ORG_NAME "Osin"
#define QAPP_ORG_DOMAIN "osinpay.com"
#define QAPP_APP_NAME_DEFAULT "Osin-Qt"
#define QAPP_APP_NAME_TESTNET "Osin-Qt-testnet"
#define QAPP_APP_NAME_DEVNET "Osin-Qt-%s"
#define QAPP_APP_NAME_REGTEST "Osin-Qt-regtest"
