...
{
    const char* pszTimestamp = "The Osin blockchain A new alternative in the world of cryptocurrencies 81357a236";
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("nodem.osin.com");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("netest.osin.com");
