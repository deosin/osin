...
{
    const char* pszTimestamp = "Get the new Osin blockchain world decentralize cryptocurrencies";
    const CScript genesisOutputScript = CScript() << ParseHex("04a44dcbf927587e668b62c7bc0ec0310623a7761530e3b5a4816abeaaa1b45cd8cc4d586c738655d38c337ec8171bd37c2ae61c162f9944a0987a14e274f73191") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Osin: 1 day
        consensus.nPowTargetSpacing = 150; // Osin: 3.5 minutes
        ...
        consensus.defaultAssumeValid = uint256S("0x0007c338dc4ad8dddc63a8f113c0eec1394c392603c78cc4378645e241a245f5"); // block hash for 0
        ...
        //FindMainNetGenesisBlock(1698413551, 0x20001fff, "main");
        genesis = CreateGenesisBlock(1698413551, 982, 0x20001fff, 4, 5000 * COIN);
        VerifyGenesisPOW(genesis);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x179efacc42d5bf2e96efea7c33dc71129bfca3b26123ba52887206f908705027"));
        assert(genesis.hashMerkleRoot == uint256S("0x1f4aaed895d3e7d98ff381dd910179fae26e24c09bded66a4e1bb2cb17f4cfe3"));

        vSeeds.emplace_back("blockchain.osinpay.com");



        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,115);
        // Osin script addresses start with '7'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,16);
        // Osin private keys start with '7' or 'X'
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,128);
        // Osin BIP32 pubkeys start with 'xpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x88, 0xB2, 0x1E};
        // Osin BIP32 prvkeys start with 'xprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x88, 0xAD, 0xE4};
        // Osin BIP44 coin type is '5'
...
//        	exit(0);
//        }
        std::vector<FounderRewardStructure> rewardStructures = {  {INT_MAX, 14} };// 10% founder/dev fee forever
        ...
        vSporkAddresses = {"oduTDeLvs1b4LM4TWyNHpzwohzpeHHjFML"};
        nMinSporkKeys = 1;
        ...
        chainTxData = ChainTxData{
            1698413551,   // * UNIX timestamp of last known number of transactions (Block 0)
...
public:
    CTestNetParams() {
        ...
        consensus.powLimit = uint256S("00ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"); // ~uint256(0) >> 20
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Osin: 1 day
        consensus.nPowTargetSpacing = 60; // Osin: 1 minutes
        ...
        vSeeds.emplace_back("testnet.osinpay.com");

        // Testnet Osin addresses start with 'r'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,123);
        // Testnet Osin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Testnet Osin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Testnet Osin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Testnet Osin BIP44 coin type is '1' (All coin's testnet default)
        std::string strExtCoinType = gArgs.GetArg("-extcoinindex", "");
...
public:
    CDevNetParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 2; // DIP0003 activated immediately on devnet
        ...
        consensus.nPowTargetTimespan = 24 * 60 * 60; // Osin: 1 day
        consensus.nPowTargetSpacing = 2 * 60; // Osin: 2 minutes
        consensus.fPowAllowMinDifficultyBlocks = true;
        consensus.fPowNoRetargeting = false;
        consensus.nPowDGWHeight = 60;
        consensus.DGWBlocksAvg = 60;
...
//      std::cout << "hash: " << consensus.hashGenesisBlock.ToString() << std::endl;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        //vSeeds.push_back(CDNSSeedData("osinevo.org",  "devnet-seed.osinevo.org"));

        // Testnet Osin addresses start with 'y'
...
public:
    CRegTestParams() {
       ...
       // consensus.DIP0003EnforcementHeight = 500;
        ...
        // Regtest Osin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Osin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
        // Regtest private keys start with '9' or 'c' (Bitcoin defaults)
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        // Regtest Osin BIP32 pubkeys start with 'tpub' (Bitcoin defaults)
        base58Prefixes[EXT_PUBLIC_KEY] = {0x04, 0x35, 0x87, 0xCF};
        // Regtest Osin BIP32 prvkeys start with 'tprv' (Bitcoin defaults)
        base58Prefixes[EXT_SECRET_KEY] = {0x04, 0x35, 0x83, 0x94};

        // Regtest Osin BIP44 coin type is '1' (All coin's testnet default)
        nExtCoinType = 1;
